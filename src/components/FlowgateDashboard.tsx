...
Certification: The structure described is reviewed and approved as Shariah-compliant by the Shariah Supervisory Board. No interest (riba) or gharar.`;
  ...
  const handleDecideProposal = (proposalId: string, approve: boolean) => {
  ...
  const handleLinkInvestor = (proposalId: string) => {
  ...
  const handleCreateCapitalCall = (e: React.FormEvent) => {
    e.preventDefault();
